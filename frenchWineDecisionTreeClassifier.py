...
print("(13.52,3.17,2.72,23.5,97),(12.42,2.55,2.27,22,90),(13.76,1.53,2.7,19.5,132)的种类分别是：")
print(model.predict([[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[13.76,1.53,2.7,19.5,132]]))
lis=model.predict([[13.52,3.17,2.72,23.5,97],[12.42,2.55,2.27,22,90],[13.76,1.53,2.7,19.5,132]])
tuple={'Syrah':['西拉'],'Zinfandel':['仙粉黛'],'Sauvignon':['赤霞珠']}
value=[]
for i in lis:
	value=value+tuple[i]
print(value)
